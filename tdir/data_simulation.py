...
#plus 1 for these specific parameters. Have to get longer segments for high pass resolution and cant do that with 86400000
#N = int(dur*f_samp)+1
#N = int(dur*f_samp)+2
N = int(dur*f_samp)+5
...
#extra = total_segment-len(h_low)
#h_low = np.pad(h_low,(0,extra),'constant')
